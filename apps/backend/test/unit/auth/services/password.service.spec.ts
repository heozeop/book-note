...
describe("PasswordService", () => {
  ...
  describe("evaluatePasswordStrength", () => {
    ...
    it("should penalize for repeated characters", () => {
      ...
      // Act
      const repeatedScore = service.evaluatePasswordStrength(
        repeatedCharsPassword,
      );
      const nonRepeatedScore =
        service.evaluatePasswordStrength(nonRepeatedPassword);
    ...
    it("should not exceed 100 points for any password", () => {
      ...
      const superStrongPassword =
        "Super_Str0ng_P@ssw0rd_With_Many_Characters!@#$%^&*()";
